  ...
  return (
    <div className=" min-h-screen py-8">
      ...
      <div className="max-w-3xl mx-auto p-8">
        <h1 className="text-4xl text-white font-bold mb-4">Welcome to <span className='text-teal-500 font-serif bg-white rounded-md p-1 shadow-lg'>BookingsDotCom</span></h1>
